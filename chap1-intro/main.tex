...
\section{History}
\input{./chap1-intro/history.tex}

\section{Electron Scattering}
\input{./chap1-intro/e_scat.tex}

\section{Bjorken Scaling}
\input{./chap1-intro/bj_scale.tex}

\section{Nuclear Structure Functions}
\input{./chap1-intro/f2.tex}

\section{$R=\sigma_L/\sigma_T$}
\input{./chap1-intro/r.tex}

\section{$F_2^n/F_2^p$}
\input{./chap1-intro/f2r.tex}

\section{EMC Ratios}
\input{./chap1-intro/emc.tex}
