...
\begin{enumerate}
	...
	\end{enumerate}
\end{enumerate}
This analysis procedure will yield the $F_2^{^3\text{He}} / F_2^{^2\text{H}}$ structure function ratio. From there, the A=3 isoscalar EMC ratio can be extracted by applying an isoscalar correction. Also, the $F_2^n / F_2^p$ nucleon structure function ratio can be extracted using the methodology described in Section \ref{sec:F2ratio}.
...
%\input{./analysis/calib.tex}

\section{Cuts}
\input{./analysis/cuts.tex}

\input{./analysis/corrections.tex}
